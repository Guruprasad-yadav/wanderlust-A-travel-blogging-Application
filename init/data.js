const sampleListings = [
...

  {
    ...
    description: "Experience royal heritage in this pink city palace stay.",
    image: {
      filename: "listingimage",
  ...
  
  {
    ...
    description: "Stay beside serene lakes with palace views.",
    image: {
      filename: "listingimage",
  ...
  
  {
    ...
    description: "Peaceful stay surrounded by lush tea plantations.",
    image: {
      filename: "listingimage",
  ...
  
  {
    ...
    description: "Stylish city apartment in tech capital.",
    image: {
      filename: "listingimage",
  ...
  },
  {
    ...
    description: "French-style beach resort with peaceful vibes.",
    image: {
      filename: "listingimage",
  ...
  
  {
    ...
    description: "Comfortable stay near historic monuments.",
    image: {
      filename: "listingimage",
  ...
  },
  {
    ...
    description: "Stay near ghats with Ganga view.",
    image: {
      filename: "listingimage",
  ...
  },
  {
    ...
    description: "Stay near waterfalls in one of the wettest places.",
    image: {
      filename: "listingimage",
...
// goa
  {
    ...
    description: "Stay just steps away from Baga Beach with vibrant nightlife and sea views.",
    image: {
      filename: "listingimage",
      url: "https://images.unsplash.com/photo-1507525428034-b723cf961d3e"
    },
  ...
  },
  {
    ...
    description: "Modern villa with pool near the famous Calangute Beach.",
    image: {
      filename: "listingimage",
